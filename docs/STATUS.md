...
- Final release checks pass: 96 backend tests (one opt-in live MCP test skipped), 19 frontend tests, the Vite production build, Python compilation, whitespace checks, source-size checks, and the Impeccable detector.
