...
MAX_MOVIE_FAMILY_RUNS = int(VALUES.get("ORPHEUS_MAX_MOVIE_FAMILY_RUNS", 3))
if not 1 <= MAX_MOVIE_FAMILY_RUNS <= 12:
    raise ValueError("Movie family run limit must be between 1 and 12")
MAX_CYCLES = 5
AUDIO_CALL_LIMIT = 6
